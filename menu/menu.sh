#!/bin/bash
BURIQ () {
    curl -sS https://raw.githubusercontent.com/AdaraS14/Ip-permision/main/ipmini > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/AdaraS14/Ip-permision/main/ipmini | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/AdaraS14/Ip-permision/main/ipmini | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
Exp=$(curl -sS https://raw.githubusercontent.com/AdaraS14/Ip-permision/main/ipmini | grep $MYIP | awk '{print $3}')
fi
...
echo -e "                 ${BICyan}Base Script : ${BIPurple}AutoVps${NC}"
echo -e "                 ${BICyan}Bot Dev     : ${BIPurple}@MAZHAB${NC}"
echo -e "                 ${BICyan}Decodec     :${BIPurple} @MASNA${NC}"
echo -e "               ${BICyan}${On_IPurple} SCRIPT MULTI VER.5.0 STABILE ${GREEN}${NC}"
echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}"
...
echo -e "${BICyan} └─────────────────────────────────────────────────────┘${NC}"
echo -e " ${BICyan}┌─────────────────────────────────────┐${NC}"
echo -e " ${BICyan}│  Version      ${NC} : VER.5.0 Last Update"
...
6969) clear ; wget https://raw.githubusercontent.com/AdaraS14/V5/main/update.sh && chmod +x update.sh && ./update.sh && rm -f /root/update.sh ;;
0) clear ; menu ;;
x) exit ;;
